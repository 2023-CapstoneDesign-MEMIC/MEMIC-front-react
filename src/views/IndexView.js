...
const scripts = [{
    loading: fetch("https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=6526603ca6ecfaa934a69294").then(body => body.text()),
    isAsync: false
    ...
    render() {
        ...
        <span className="af-view">
          <div>
            <div id="home" className="af-class-page-wrapper">
              <div data-animation="default" className="af-class-navbar12_component w-nav" data-easing2="ease"
                   fs-scrolldisable-element="smart-nav" data-easing="ease" data-collapse="medium"
                   data-w-id="18a77209-24cc-8d26-8fa2-7e9adce00f9d" role="banner" data-duration={400} id="nav_bar">
                <div className="af-class-navbar12_container">
                  <a href="/" aria-current="page" className="af-class-navbar12_logo-link w-nav-brand w--current"><img
                      src="images/logo.png" loading="lazy" width={42} alt="logo for navbar
        " className="af-class-navbar12_logo"/></a>
                  ...
                  <nav role="navigation" className="af-class-navbar12_menu af-class-is-page-height-tablet w-nav-menu">
                    <a href="#Improve" className="af-class-navbar12_link w-nav-link">소개</a>
                    <a href="#Start_now" className="af-class-navbar12_link w-nav-link">시작하기</a>
                    <div data-hover="true" data-delay={200} data-w-id="18a77209-24cc-8d26-8fa2-7e9adce00fa8"
                         className="af-class-navbar12_menu-dropdown w-dropdown">
                      <div className="af-class-navbar12_dropdown-toggle w-dropdown-toggle">
                        <div>더보기</div>
                        <div className="af-class-dropdown-chevron w-embed"><svg width=" 100%" height=" 100%"
                      ...
                      <nav data-w-id="18a77209-24cc-8d26-8fa2-7e9adce00fad"
                           className="af-class-navbar12_dropdown-list w-dropdown-list">
                        <div className="af-class-navbar12_dropdown-link-list">
                            ...
                            <a href="fileupload" className="af-class-navbar12_dropdown-link w-inline-block">
                              <div className="af-class-navbar12_icon-wrapper">
                                <div className="af-class-icon-embed-xsmall w-embed"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" className="af-class-iconify af-class-iconify--ic"
              ...
              <main className="af-class-main-wrapper">
                        ...
                        <div className="w-layout-grid af-class-home_feature_component">
                          <div className="af-class-home_feature_content">
                            <div className="af-class-margin-bottom af-class-margin-small">
                              <h1 className="af-class-heading">당신만을 위한<br/>성대모사 도우미</h1>
                            </div>
                            <div className="af-class-margin-bottom af-class-margin-medium">
                              <p className="af-class-text-size-medium">ME:MIC은 이런 서비스에요.</p>
                            </div>
                            <div className="w-layout-grid af-class-home_feature_item-list">
                              <div className="af-class-home_feature_item">
                                <div className="af-class-margin-bottom af-class-margin-xsmall"><img
                                    src="images/icon_check.svg" loading="lazy" alt
                                    className="af-class-icon-1x1-medium"/></div>
                                <div className="af-class-margin-bottom af-class-margin-xsmall">
                                  <h6>쉬운 업로드</h6>
                                </div>
                                <p>음성 파일 또는<br/>URL을 입력해 음성을 추출해보세요.</p>
                              </div>
                              <div className="af-class-home_feature_item">
                                <div className="af-class-margin-bottom af-class-margin-xsmall"><img
                                    src="images/icon_check.svg" loading="lazy" alt
                                ...
                                <p>ME:MIC이 제공하는<br/>성대모사 피드백을 확인해보세요.</p>
                              </div>
                            </div>
                          </div><img src="images/sound-volume.gif" loading="lazy" width={685}
                                     id="w-node-_53bf7523-5820-619c-38ae-43972fb2398f-34a692c8" alt
                ...
                <section className="af-class-section_home_how-it-works">
                        ...
                        <div className="af-class-home_how-it-works_component" style={{color: '#ffffff'}}>
                          <div className="af-class-margin-bottom af-class-margin-xxlarge">
                            <div className="af-class-text-align-center">
                              <div className="af-class-max-width-large">
                                <div className="af-class-margin-bottom af-class-margin-small">
                                  <h1 className="af-class-text-color-white">성대모사 스킬을 키워보세요</h1>
                                </div>
                                <p className="af-class-text-size-medium af-class-text-color-white">ME:MIC에서 효과적으로 성대모사를 연습할 수 있습니다.</p>
                              </div>
                            </div>
                          </div>
                          <div className="w-layout-grid af-class-home_how-it-works_list">
                            <address className="af-class-home_how-it-works_item">
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <div className="af-class-icon-embed-medium w-embed"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" className="af-class-iconify af-class-iconify--ic"
                                    width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                              ...
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <h3 className="af-class-heading-style-h4 af-class-text-color-white">파일 업로드 & 녹음</h3>
                              </div>
                              <p className="af-class-text-color-white">음성 파일이나 URL을 입력하고<br/>최대한 비슷하게 따라해보세요.</p>
                            </address>
                            <div className="af-class-home_how-it-works_item">
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <div className="af-class-icon-embed-medium-2 w-embed"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" className="af-class-iconify af-class-iconify--tabler"
                                    width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                              ...
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <h3 className="af-class-heading-style-h4 af-class-text-color-white">성대모사 비교</h3>
                              </div>
                              <p className="af-class-text-color-white">ME:MIC의 분석이 끝나면<br/>성대모사와 녹음본을 비교하세요.</p>
                            </div>
                            <div id="w-node-_18a77209-24cc-8d26-8fa2-7e9adce01041-34a692c8"
                                 className="af-class-home_how-it-works_item">
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <div className="af-class-icon-embed-medium-3 w-embed"><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" className="af-class-iconify af-class-iconify--tabler"
                                    width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                      ...
                                      <path
                                          d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zm0 12v-5m3 5v-1m3 1v-3"/>
                                    </g>
                                  </svg></div>
                              </div>
                              <div className="af-class-margin-bottom af-class-margin-small">
                                <h3 className="af-class-heading-style-h4 af-class-text-color-white">보고서 & 피드백</h3>
                              </div>
                              <p className="af-class-text-color-white">개별 피드백을 받아보세요.<br/>그리고 성장하세요.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="af-class-home_how-it-works_background-image-wrapper">
                    <div className="af-class-image-overlay-layer"/><img src="images/placeholder-image.svg"
                                                                        loading="lazy" alt
                                                                        className="af-class-home_how-it-works_background-image"/>
                  </div>
                </section>
                    ...
                    <div className="af-class-container-small">
                      <div className="af-class-padding-section-large">
                        <div className="af-class-text-align-center">
                          ...
                          <p className="af-class-text-size-medium">당신만을 위한 성대모사 서비스</p>
                          <div className="af-class-margin-top af-class-margin-medium">
                            <div className="af-class-button-group af-class-is-center">
                              <a href="fileupload"
                                 className="af-class-button af-class-is-secondary af-class-is-small w-button">시작하기</a>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <section className="af-class-section_cta28">
                <div className="af-class-cta28_background-image-wrapper">
                  <div className="af-class-image-overlay-layer"/><img src="images/placeholder-image.svg" loading="lazy"
                                                                      alt className="af-class-cta28_background-image"/>
                </div>
              </section>
              <section className="af-class-section_cta_2">
                <div className="af-class-cta27_background-image-wrapper">
                  <div className="af-class-image-overlay-layer"/><img src="images/placeholder-image.svg" loading="lazy"
                                                                      alt className="af-class-cta27_background-image"/>
                </div>
              </section>
                  ...
                  <div className="af-class-container-large">
                    <div className="af-class-padding-vertical af-class-padding-xxlarge">
                        <div className="w-layout-grid af-class-footer4_top-wrapper">
                          <a href="#" id="w-node-_18a77209-24cc-8d26-8fa2-7e9adce0106a-34a692c8"
                             className="af-class-footer4_logo-link w-nav-brand"><img src="images/logo.png"
                                                                                     loading="lazy" width={42} alt="logo for navbar
        " className="af-class-navbar12_logo"/></a>
                          <div className="w-layout-grid af-class-footer4_link-list">
                              <div id="w-node-_18a77209-24cc-8d26-8fa2-7e9adce01085-34a692c8"
                                   className="af-class-footer4_credit-text">© 2023 ME:MIC. All rights reserved.</div>
                          </div>
                          <div id="w-node-_5413a46b-6025-d22b-adfc-5c72693f1a7e-34a692c8"
                               className="w-layout-grid af-class-footer4_social-list">
                            <a href="https://www.notion.so/8c7c66798028437a9f25ee3e0519b77d" target="_blank"
                               className="af-class-footer4_social-link w-inline-block">
                              <div className="af-class-icon-embed-xsmall w-embed"><svg
                                  xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                  aria-hidden="true" role="img"
                                  className="af-class-iconify af-class-iconify--simple-icons" width="100%" height="100%"
                            ...
                            <a href="https://github.com/2023-CapstoneDesign-MEMIC" target="_blank"
                               className="af-class-footer4_social-link w-inline-block">
                              <div className="af-class-icon-embed-xsmall w-embed"><svg
                                  xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                  aria-hidden="true" role="img"
